...
public class InformationSchema {
	public static void main(String[] args) {
		try {
			 ...
			 */
			//System.out.println("youreached here?");
			
			new File("D:/V_Ramaraj/information_schema/information_schema.columns.tbl").createNewFile();
			new File("D:/V_Ramaraj/information_schema/information_schema.schemata.tbl").createNewFile();
			new File("D:/V_Ramaraj/information_schema/information_schema.table.tbl").createNewFile();
...
//System.out.println("it eached here");
			/*
